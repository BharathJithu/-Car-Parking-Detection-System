...
positions = [
    (60, 100), (170, 100), (270, 100), (380, 100),
    (70, 320), (160, 320), (270, 320), (370, 320)
]
...
def checkParkingSpace(imgPro):
    ...
    cvzone.putTextRect(img, f'Free: {free_slots}', (0, 100), scale=1, thickness=1, offset=10, colorR=(94, 10, 6))
